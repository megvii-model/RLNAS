...
class TestServer(MessageQueueServerBase):
    ...
    def get_arch_vector(self, model, normal_cand, reduction_cand):
        ...
        stem = torch.cat([model.stem[0].weight.data.reshape(-1),
            ...
            for path in config.paths:
                ...
                for index in range(1, len(path)):
                    ...
                    if cand[i][k + offset] == config.NONE:  # None
                        ...
                        param_cell += [torch.cat([pooling_param.reshape(-1).cuda(),
                                                  model.cells[i]._ops[k + offset]._ops[cand[i][k + offset]][
                                                      1].weight.data.reshape(-1),
                                                  model.cells[i]._ops[k + offset]._ops[cand[i][k + offset]][
                                                      1].bias.data.reshape(-1)])]
                        ...
                        if isinstance(model.cells[i]._ops[k + offset]._ops[cand[i][k + offset]], FactorizedReduce):
                            param_cell += [torch.cat([model.cells[i]._ops[k + offset]._ops[
                                                          cand[i][k + offset]].conv_1.weight.data.reshape(-1),
                                                      model.cells[i]._ops[k + offset]._ops[
                                                          cand[i][k + offset]].conv_2.weight.data.reshape(-1),
                                                      model.cells[i]._ops[k + offset]._ops[
                                                          cand[i][k + offset]].bn.weight.data.reshape(-1),
                                                      model.cells[i]._ops[k + offset]._ops[
                                                          cand[i][k + offset]].bn.bias.data.reshape(-1)])]
