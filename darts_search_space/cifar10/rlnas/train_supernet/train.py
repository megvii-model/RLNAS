...
def main():
  ...
  train_data = utils.Cifar10RandomLabels(root=args.data, train=True, download=True, transform=train_transform, rand_seed=args.seed)
  ...
  for epoch in range(args.epochs):
    ...
    # training
    seed, train_acc, train_obj = train(train_queue, model, criterion, optimizer, operations, seed)
...
def train(train_queue, model, criterion, optimizer, operations, seed):
