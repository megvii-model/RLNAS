...
new_save_dir=./output/test-cell-nas-bench-102/rlnas-${dataset}-cal-correlation-runs-${runs}-seed-${seed}-base-epoch-${base_epoch}
save_dir=./output/search-cell-nas-bench-102/rlnas-${dataset}-runs-${runs}-seed-${seed}

/usr/bin/python3 ./exps/algos/transfer_robustness.py \
